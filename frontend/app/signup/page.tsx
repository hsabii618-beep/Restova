    ...
    <AuthLayout
      ...
      subtitle={
        <>
          ...
          <Link href="/login" style={{ color: 'var(--color-brand-primary)', fontWeight: 600 }}>Log in here</Link>
        </>
      }
    >
      {error && (
      ...
      <div style={{ display: 'flex', alignItems: 'center', marginBottom: '24px' }}>
        ...
        <div style={{ padding: '0 12px', fontSize: '14px', color: 'var(--color-text-muted)' }}>or sign up with email</div>
        <div style={{ flex: 1, height: '1px', background: 'var(--color-border-light)' }}></div>
      </div>
      ...
      <form onSubmit={handleSignup} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
        ...
        <p style={{ textAlign: 'center', fontSize: '13px', color: 'var(--color-text-muted)', marginTop: '8px', lineHeight: '1.5' }}>
